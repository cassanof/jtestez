// Generated by delombok at Sat May 07 00:26:10 EDT 2022
...
class MtLoTrigram implements ILoTrigram {
  ...
  */
  ...
  // occurrences
  // prevTri keeps the previous trigram and prevCount keeps its occurrences
  public Trigram mostCommonTrigramHelp(Trigram maxTri, int maxCount, Trigram prevTri, int prevCount) {
    /*
    * TEMPLATE:
...
class ConsLoString implements ILoString {
  ...
  */
  ...
  public ILoTrigram trigrams() {
    if (this.length() >= 3) {
      return new ConsLoTrigram(new Trigram(this.getAt(0), this.getAt(1), this.getAt(2)), this.rest.trigrams());
    } else {
      return new MtLoTrigram();
    }
  }
  ...
  @java.lang.SuppressWarnings("all")
  public java.lang.String toString() {
    return "new ConsLoString(" + BetterToString.make(this.first) + ", " + BetterToString.make(this.rest) + ")";
  }
}
...
class Utils {
  ...
  */
  ...
  String confrimValidTrigramWord(String s) {
    if (s.contains(" ")) {
      throw new IllegalArgumentException("The given word <" + s + "> has spaces, thus it is invalid for a trigram");
    }
    if (s.equals("")) {
      throw new IllegalArgumentException("The given word is an empty string, thus it is invalid for a trigram");
    }
    return s;
  }
}
